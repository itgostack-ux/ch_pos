...
import { InboundReceiveWorkspace } from "./pos_app/modules/inbound_receive/inbound_receive_workspace.js";
...
ch_pos.PosApp = class PosApp {
	...
	_init_modules() {
		...
		this.inbound_receive_workspace = new InboundReceiveWorkspace();
