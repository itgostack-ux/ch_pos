...
CUSTOM_FIELDS = {
    ...
    "Sales Invoice": [
        ...
        {
            "fieldname": "custom_import_batch_hash",
            "fieldtype": "Data",
            "label": "Import Batch Hash",
            "insert_after": "custom_client_request_id",
            "read_only": 1,
            "no_copy": 1,
            "hidden": 1,
            "description": "SHA256 hash of CSV import batch; used to prevent re-import duplicates",
            "module": "POS Core",
        },
        {
            ...
            "insert_after": "custom_import_batch_hash",
            "no_copy": 1,
            "module": "POS Core",
        },
        # ── Payment type fields ──────────────────────────────────
